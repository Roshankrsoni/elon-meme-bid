...
Deno.serve(async (req) => {
  ...
  // Per-spot starting bids — every spot opens at $10
  // (mirrors minBid in brandSlotDefs). Unknown spots fall back to the $10 floor.
  ...
  const spotFloor = SPOT_MINIMUMS_CENTS[bid.spot_id] ?? 1000
